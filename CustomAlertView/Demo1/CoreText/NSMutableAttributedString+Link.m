...
// 网页链接
static NSString *const kUrlTitle = @"网页链接 ";
...
- (NSMutableAttributedString *)addUrlAttStringWithLinkData:(TLAttributedLink *)linkData
    ...
    if (!self.urlAttString) {
        ...
        imageData.attributedImage = [UIImage imageNamed:@"timeline_card_small_web"];
        ...
        // 生成完成的链接
        NSMutableAttributedString *attString = [[NSMutableAttributedString alloc] initWithString:kUrlTitle];
