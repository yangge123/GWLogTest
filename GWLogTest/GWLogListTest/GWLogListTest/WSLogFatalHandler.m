...
- (void)validateAndSaveCrashData:(NSException *)exception
{
...
{
    [self validateAndSaveCrashData:exception];
...
void HandleException(NSException *exception)
{
    ...
    NSArray *callStack = [GWLogFatalHandler backtrace];
